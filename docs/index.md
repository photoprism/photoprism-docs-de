...
* Privatsphäre: PhotoPrism sendet keine Daten an Google, Amazon, Microsoft oder Apple, es sei denn, du lädst explizit Dateien auf einen dieser Dienste hoch :closed_lock_with_key:
...
* Sechs hochauflösende [Weltkarten](https://demo-de.photoprism.app/library/places) lassen Erinnerungen an deine Lieblingsreisen wieder aufleben
...
[Vollständige Funktionsübersicht ›](https://www.photoprism.app/editions/#compare)
...
Deine Daten werden auch niemals an Google, Amazon, Microsoft oder Apple weitergegeben, es sei denn, du lädst absichtlich Dateien auf einen dieser Dienste hoch.
