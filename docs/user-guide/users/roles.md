...
!!! example ""
    *Benutzer* und *Betrachter* sind mit [Essentials und Plus](https://www.photoprism.app/editions/#compare) verfügbar; unsere Community Edition stellt *Admin*, *Gast* und *Besucher* bereit. PhotoPrism Pro bietet zusätzliche Rollen für delegierte Administration und Upload-orientierte Arbeitsabläufe, siehe [Managing User Accounts](https://www.photoprism.app/pro/kb/roles/) in der Pro Knowledge Base.
