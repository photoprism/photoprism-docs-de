...
![Screenshot](img/edit-details-german.png){ class="shadow" }
...
![Screenshot](img/edit-files-1-german.png){ class="shadow" }

Um die Details einer Datei anzuzeigen, klicke auf :material-chevron-down:.

![Screenshot](img/edit-files-2-german.png){ class="shadow" }
