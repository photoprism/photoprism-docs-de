...
PhotoPrism bietet außerdem eine 3D-Erdansicht, die deine Aufnahmeorte aus der Perspektive eines Globus zeigt. Damit kannst du dir deine Bilder in einer realistischeren, dreidimensionalen Darstellung der Welt ansehen.

Um die 3D-Erdansicht zu aktivieren:

1. Klicke auf :material-earth:, um zwischen Karte und 3D-Erdansicht zu wechseln

In der 3D-Erdansicht kannst du:

- den Globus drehen, indem du ihn mit gedrückter Maustaste ziehst
- mit dem Mausrad oder einer Zwei-Finger-Geste hinein- und herauszoomen
- die Perspektive kippen, indem du die rechte Maustaste gedrückt hältst und die Maus bewegst

Die 3D-Erdansicht funktioniert mit allen Kartenstilen und lässt sich mit dem 3D Modus kombinieren, um deine Aufnahmeorte noch detaillierter darzustellen.
