...
Webbrowser können keine RAW-Formate anzeigen. Deshalb muss PhotoPrism diese Dateien *konvertieren*. Um diese Schritte zu konfigurieren, findest du entsprechende Optionen in den [Einstellungen](ui.md).
